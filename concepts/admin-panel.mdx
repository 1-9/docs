---
title: "Admin Panel"
description: "How the Domainer Engine admin panel is organized and how to navigate it."
---
...
Templates use a drag-and-drop block system — see [Page Builder](/configuration/page-builder) for details.
