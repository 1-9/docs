---
title: "Offers"
description: "Review, counter, accept, or reject price offers submitted by buyers — track the offer status flow with automatic email and Telegram notifications."
---
...
Pending offers also surface on the admin **Dashboard** under **Recent Offers**, with Accept / Reject buttons and an inline Counter flow (enter an amount, no need to open the full record) for quick handling without leaving the dashboard.
