...
description: "Step-by-step guide to deploying Domainer Engine on Vercel with a free Neon PostgreSQL database."
---

[VIDEO: Deploy on Vercel — full walkthrough]
...
<Info>
  Before you start, make sure you have received a GitHub repository invite. Without it, you won't be able to fork the repository. If you haven't received an invite or it has expired, contact me to get a new one.
</Info>

<Steps>
  <Step title="Fork the repository">
    Open the repository you were invited to on GitHub and click **Fork** → **Create fork**.
