...
If the platform or storefront where you purchased Domainer Engine supports update notifications, you'll receive one when a new version is available. You can also check for updates at any time by visiting your purchase history.
